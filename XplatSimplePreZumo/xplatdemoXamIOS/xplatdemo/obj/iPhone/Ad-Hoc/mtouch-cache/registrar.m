...
void *
native_to_managed_trampoline_Xamarin_Auth_WebAuthenticatorController_WebViewDelegate_ShouldStartLoad (id this, SEL sel, id p0, id p1, int p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_AppDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_AppDelegate_get_Window (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_AppDelegate_set_Window (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_get_activityIndicator (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_set_activityIndicator (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_get_itemText (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_set_itemText (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_RowsInSection (id this, SEL sel, id p0, int p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_NumberOfSections (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_GetCell (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_TitleForDeleteConfirmation (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_EditingStyleForRow (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_CommitEditingStyle (id this, SEL sel, id p0, int p1, id p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_44, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_OnAdd (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_xplatdemo_QSTodoListViewController_ShouldReturn (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"AppDelegate", "xplatdemo.AppDelegate, xplatdemo", 0},
	...
	{"QSTodoListViewController", "xplatdemo.QSTodoListViewController, xplatdemo", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"Xamarin.Auth.WebAuthenticatorController+WebViewDelegate", "NSObject", 1, 4, 0},
	...
	{"QSTodoListViewController", "UITableViewController", 1, 13, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"webView:shouldStartLoadWithRequest:navigationType:","B@:@@i",0, &native_to_managed_trampoline_Xamarin_Auth_WebAuthenticatorController_WebViewDelegate_ShouldStartLoad},
	...
	{"init","@@:",0, &native_to_managed_trampoline_xplatdemo_AppDelegate__ctor},
	{"window","@@:",0, &native_to_managed_trampoline_xplatdemo_AppDelegate_get_Window},
	{"setWindow:","v@:@",0, &native_to_managed_trampoline_xplatdemo_AppDelegate_set_Window},
	...
	{"activityIndicator","@@:",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_get_activityIndicator},
	{"setActivityIndicator:","v@:@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_set_activityIndicator},
	{"itemText","@@:",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_get_itemText},
	{"setItemText:","v@:@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_set_itemText},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_ViewDidLoad},
	{"tableView:numberOfRowsInSection:","i@:@i",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_RowsInSection},
	{"numberOfSectionsInTableView:","i@:@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_NumberOfSections},
	{"tableView:cellForRowAtIndexPath:","@@:@@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_GetCell},
	{"tableView:titleForDeleteConfirmationButtonForRowAtIndexPath:","@@:@@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_TitleForDeleteConfirmation},
	{"tableView:editingStyleForRowAtIndexPath:","i@:@@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_EditingStyleForRow},
	{"tableView:commitEditingStyle:forRowAtIndexPath:","v@:@i@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_CommitEditingStyle},
	{"OnAdd:","v@:@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_OnAdd},
	{"textFieldShouldReturn:","B@:@",0, &native_to_managed_trampoline_xplatdemo_QSTodoListViewController_ShouldReturn},
};

static MTProperty __monotouch_properties [] = {
};

int __monotouch_map_count = 62;
